...
class SettingsRepositoryImpl @Inject constructor(
    ...
    override fun userSettings(): Flow<UserSettingsData> {
        return dataStore.data
            ...
            .map { prefs ->
                UserSettingsData(
                    name = prefs[USER_NAME] ?: "Usuario demo",
                    email = prefs[USER_EMAIL] ?: "user@adopcion.app",
    ...
    override fun shelterSettings(): Flow<ShelterSettingsData> {
        return dataStore.data
            ...
            .map { prefs ->
                ShelterSettingsData(
                    shelterName = prefs[SHELTER_NAME] ?: "Protectora demo",
                    email = prefs[SHELTER_EMAIL] ?: "protectora@adopcion.app",
